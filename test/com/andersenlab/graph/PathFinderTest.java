...
public class PathFinderTest {
    ...
    public void getOptiomalPathOneStep() throws Exception {
        Graph graph = new Graph.Builder()
                ...
                .edge(2, 4, 5.1)
                .build();
        List<Edge> edges = new PathFinder(graph, 1, 4).getOptiomalPath();
    ...
    public void getOptiomalPathTwoSteps1() throws Exception {
        Graph graph = new Graph.Builder()
                ...
                .edge(2, 4, 5.1)
                .build();
        List<Edge> edges = new PathFinder(graph, 1, 5).getOptiomalPath();
    ...
    public void getOptiomalPathTwoSteps2() throws Exception {
        Graph graph = new Graph.Builder()
                ...
                .edge(2, 4, 5.1)
                .build();
        List<Edge> edges = new PathFinder(graph, 1, 3).getOptiomalPath();
